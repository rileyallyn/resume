...
<div
  class="sticky top-0 z-10 flex flex-col gap-4 border-b border-zinc-200/90 bg-white/90 px-3 py-1.5 backdrop-blur-md backdrop-saturate-150 sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-10 dark:border-zinc-800 dark:bg-zinc-900/90"
>
  <div class="flex min-w-0 flex-row items-center gap-2">
    <h2 class="text-xl font-semibold tracking-tight text-balance text-zinc-900 sm:text-2xl dark:text-zinc-50">
      {name}
    </h2>
    <p
      class="mt-1 rounded-full bg-zinc-100 px-2 py-1 font-mono text-xs text-zinc-500 dark:bg-zinc-900 dark:text-zinc-400"
    >
      /{slug}
    </p>
  </div>
  <div class="flex flex-wrap items-center gap-2 self-start">
    ...
    <a
      ...
      rel="noopener noreferrer"
      class="inline-flex items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white px-3.5 py-2 text-xs font-semibold text-zinc-800 shadow-sm transition hover:border-zinc-300 hover:bg-zinc-50 focus-visible:ring-2 focus-visible:ring-violet-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-white focus-visible:outline-none dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:border-zinc-600 dark:hover:bg-zinc-800 dark:focus-visible:ring-offset-zinc-900"
      title="Opens the printable resume and your browser’s print dialog"
    >
      <span>PDF</span>
      <svg
